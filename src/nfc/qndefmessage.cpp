...
/*!
    @return Returns an NDEF message parsed from the contents of @a message.

    @param message The @a message parameter is interpreted as the raw message format defined in the NFC Data
...
/*!
    @return Returns true if this NDEF message is equivalent to @a other; otherwise returns false.

    @param other The NDEF message to compare
...
/*!
    @return Returns the NDEF message as a byte array.
